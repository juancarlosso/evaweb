                        ...
                        <div>
                          <div><a class="logo" href="index.html"><img class="img-fluid for-light"
                            ...
                            <div class="login-main">
                                <form class="theme-form"  method="post" action="{{route('change-password-update')}}">
                                    @csrf
                                    <h4>Nuevo password</h4>
                                    <h5 class="mt-4">Hola {{ $user->name }}, A continuación debes capturar tu nuevo
                                        password y confirmarlo. Al menos debe tener una longitud de 6 caracteres.</h5>
                                    <p>
                                        @include('layouts.alertas')
                                    </p>
                                    <div class="form-group mt-4">
                                        <label class="col-form-label">Nuevo password</label>
                                    ...
                                    <div class="form-group mb-0">
                                        <button class="btn btn-primary btn-block w-100" type="submit">Aceptar</button>
                                    </div>
