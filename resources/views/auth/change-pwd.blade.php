	...
	<body id="kt_body" class="app-blank">
        ...
        @csrf
								...
								<div class="text-center mb-10">
									...
									<!--end::Title-->
									<!--begin::Link-->
									<div class="text-gray-500 fw-semibold fs-6">Hola {{ $user->name }}, A continuación debes capturar tu nuevo
         password y confirmarlo. Al menos debe tener una longitud de 6 caracteres</div>
									<!--end::Link-->
								</div>
        <p>
          @include('layouts.alertas')
           ...
           <input type="hidden" name="user_id" value="{{ $user->id }}">
									...
									<!--end::Wrapper-->
									<!--begin::Hint-->
									<div class="text-muted">El password debe tener al menos 6 caracteres.</div>
									<!--end::Hint-->
								</div>
								<!--end::Input group=-->
								<!--end::Input group=-->
								<div class="fv-row mb-8">
									...
									<input type="password" placeholder="Confirmar contraseña" name="password_confirmation" autocomplete="off" class="form-control bg-transparent" />
									<!--end::Repeat Password-->
								</div>
								<!--end::Input group=-->
								<!--begin::Action-->
