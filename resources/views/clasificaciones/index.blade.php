        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Buscar registro" />
                </div>
                <!--end::Search-->
            </div>
            <!--begin::Card title-->
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_user">
                        <i class="ki-duotone ki-plus fs-2"></i>Agregar registro</button>
                    <!--end::Add user-->
                </div>
                <!--end::Toolbar-->
                <!--begin::Group actions-->
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header" id="kt_modal_add_user_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bold">Agregar registro</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                            ...
                            <div class="modal-body px-5 my-7">
                                <!--begin::Form-->
                                <form id="kt_modal_add_user_form" class="form" action="{{route('clasificaciones.store')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <!--begin::Scroll-->
                ...
                <tbody class="text-gray-600 fw-semibold">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="hidden" value="{{route('clasificaciones.edit',[$registro->id,$tipo])}}" id="url_editar_{{$tipo}}_{{$registro->id}}">
                            <input type="hidden" value="{{route('clasificaciones.update',$registro->id)}}" id="url_update_{{$tipo}}_{{$registro->id}}">
                            <button type="button" class="btn btn-icon btn-sm h-auto btn-color-gray-500 btn-active-color-primary justify-content-end" onclick="getInfo({{$registro->id}},'{{$tipo}}')" title="Editar">
                                <i class="fa-duotone fa-solid fa-pen-to-square fs-2"></i>
                            </button>

                            <a href="javascript:borrado({{ $registro->id }})" class="menu-link px-3" data-kt-users-table-filter="delete_row">
                            ...
                            <form action="{{ route('clasificaciones.destroy', $registro->id) }}"
                                method="post" name="formBorrar{{ $registro->id }}"
                                id="formBorrar{{ $registro->id }}">
                                @csrf
                                <input type="hidden" name="tipo" value="{{$tipo}}">
                                {{ method_field('DELETE') }}
                            </form>
...
@endsection
@section('scripts')
<script src="{{asset('js/clasificaciones/listado.js')}}"></script>
<script src="{{asset('js/clasificaciones/acciones.js')}}"></script>
@endsection