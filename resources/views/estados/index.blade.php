...
<div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
    <!--begin::Title-->
    <h1 class="d-flex text-gray-900 fw-bold m-0 fs-3">Estados
        <!--begin::Separator-->
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Buscar Estado" />
                </div>
                <!--end::Search-->
            </div>
            <!--begin::Card title-->
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_user">
                        <i class="ki-duotone ki-plus fs-2"></i>Agregar Estado</button>
                    <!--end::Add user-->
                </div>
                <!--end::Toolbar-->
                <!--begin::Group actions-->
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header" id="kt_modal_add_user_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bold">Agregar Estado</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                            ...
                            <div class="modal-body px-5 my-7">
                                <!--begin::Form-->
                                <form id="kt_modal_add_user_form" class="form" action="{{route('estados.store')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <!--begin::Scroll-->
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header" id="editarModal_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bold">Editar Estado</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                                <div class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-dismiss="modal" data-kt-users-modal-action="close">
                                    <i class="ki-duotone ki-cross fs-1">
                ...
                <tbody class="text-gray-600 fw-semibold">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="hidden" value="{{route('estados.edit',$estado->id)}}" id="url_editar{{$estado->id}}">
                            <input type="hidden" value="{{route('estados.update',$estado->id)}}" id="url_update{{$estado->id}}">

                            <button type="button" class="btn btn-icon btn-sm h-auto btn-color-gray-500 btn-active-color-primary justify-content-end" onclick="getInfo({{$estado->id}})" title="Editar">
                                <i class="fa-duotone fa-solid fa-pen-to-square fs-2"></i>
                            </button>

                            <a href="javascript:borrado({{ $estado->id }})" class="menu-link px-3" data-kt-users-table-filter="delete_row">
                            ...
                            <form action="{{ route('estados.destroy', $estado->id) }}"
                                method="post" name="formBorrar{{ $estado->id }}"
                                id="formBorrar{{ $estado->id }}">
                                @csrf
                                {{ method_field('DELETE') }}
                            </form>
...
@endsection
@section('scripts')
<script src="{{asset('js/estados/listado.js')}}"></script>
<script src="{{asset('js/estados/acciones.js')}}"></script>
@endsection